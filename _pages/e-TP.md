...
<!-- **Teacher Welcomes** - An explicit welcome to students from the teacher can be a key foundational strategy for establishing a sense of teacher presence. This can include the inclusion of [Welcome Videos]({{ site.baseurl }}/strategies/welcome-videos.html), Voice Recordings, and [Photographs & Other Images. -->
